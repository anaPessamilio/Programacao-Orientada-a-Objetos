...
string Data::getData() {
  string data = "";
    ostringstream dias, mess, anos, horas, minutos, segundos;
   ...
   if (strcmp(formatoData.getNome().c_str(),"PT-BR")==0)
    {
      data = dias.str() + formatoData.getSeparadorData() + mess.str() + formatoData.getSeparadorData() + anos.str() + " " + horas.str() + formatoData.getSeparadorHorario() + minutos.str() + formatoData.getSeparadorHorario() + segundos.str();

    }
   else if (strcmp(formatoData.getNome().c_str(),"EN-US")==0)
    {
       data = anos.str() + formatoData.getSeparadorData() + mess.str() + formatoData.getSeparadorData() + dias.str() + " " + horas.str()  + formatoData.getSeparadorHorario() + minutos.str() + formatoData.getSeparadorHorario() + segundos.str();
    }
    else {       //Tratamento de excecao de formato invalido
        char message[100] = "Erro: Esperado argumento PT-BR ou EN-US";
        throw ExecaoCustomizada(message);
